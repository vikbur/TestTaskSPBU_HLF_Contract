 ...
 * {@link BeanDescriptorProvider BeanDescriptorProvider} you have to
...
public class GensonBuilder {
   ...
   * {@link ClassMetadataConverter ClassMetadataConverter} for more
  ...
  /**
   * Replaces default {@link BeanMutatorAccessorResolver
  ...
  /**
   * Replaces default {@link PropertyNameResolver
   ...
   *
   * @see ClassMetadataConverter ClassMetadataConverter
   */
   ...
   * @return a reference to this builder.
   * @see ASMCreatorParameterNameResolver
   ...
   * look at {@link ASMCreatorParameterNameResolver
   * ASMCreatorParameterNameResolver}.
   *
   * @param enabled
   * @return a reference to this builder.
   ...
   * {@link ChainedFactory ChainedFactory} or if you need to chain
   * them differently.
   *
   ...
   * {@link PropertyNameResolver PropertyNameResolver} that are
   ...
   * {@link PropertyNameResolver.CompositePropertyNameResolver
   ...
   * {@link BeanDescriptor BeanDescriptor} instances for
