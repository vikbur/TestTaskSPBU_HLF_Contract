 ...
 * default, to enable it use {@link GensonBuilder#useClassMetadata(boolean)}.
 ...
 * @param <T>
 * @author eugen
 * @see ObjectWriter#writeMetadata(String, String) ObjectWriter.metadata(key, value)
 * @see ObjectReader#metadata(String) ObjectReader.metadata("class")
 * @see Genson#aliasFor(Class) Genson.aliasFor(Class)
 */
